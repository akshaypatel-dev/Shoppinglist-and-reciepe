  ...
  recipes: RecipeModel[] = [
    ...
    },
    {
      ...
      description: 'This simple, seasonal recipe teams up seared chicken and brown rice,' +
        ' loaded with late-summer vegetables. We’re tossing the grains with toasty brown butter—simply butter heated in a pan for a couple of minutes—and a quick sauté of sweet corn.' +
